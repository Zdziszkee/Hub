...
@Getter
@Configuration(name = "settingsgui.json")
public class SettingsGUIConfiguration extends Config {
    private String guiName = "example";
    private GUIItemStack visibilityItem = new GUIItemStack("name", Material.ENDER_PEARL,"lore");
    private GUIItemStack chatItem = new GUIItemStack("name", Material.PAPER,"lore");
    private GUIItemStack timeItem = new GUIItemStack("name", Material.WATCH,"lore");
    private GUIItemStack flyItem = new GUIItemStack("name", Material.FEATHER,"lore");
